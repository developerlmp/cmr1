...
# you would most likly not want to store the value in the database but 
# rather just make this a function we can run each time we load the customers profile
